...
项目当前内置版本为 `v9.8`，适合在 macOS 本地运行，也支持 AMD64 NAS 通过 Docker 部署。
...
```bash
docker load -i zzs-bili-gallery_v9.8_amd64.tar
```
...
- `zzs-bili-gallery_v9.8_amd64.tar`
