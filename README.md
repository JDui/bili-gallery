...
项目当前内置版本为 `v5.29`，适合在 macOS 本地运行，也支持 AMD64 NAS 通过 Docker 部署。
...
```bash
docker load -i zzs-bili-gallery_v5.29_amd64.tar
```
...
- `docker_app/dist/zzs-bili-gallery_v5.29_amd64.tar`
